...
import flip_arrow from 'E:/iView Labs/Crayon-newbuild-frontend-master/src/assets/flip_arrow.svg';
...
import SingleRadialChart from 'E:/iView Labs/Crayon-newbuild-frontend-master/src/components/common/SingleRadialChart';
import SmallButton from 'E:/iView Labs/Crayon-newbuild-frontend-master/src/components/common/SmallButton';
import CustomCard from 'E:/iView Labs/Crayon-newbuild-frontend-master/src/components/common/CustomCard';
import PlaceIcon from '@mui/icons-material/Place';
import KeyboardArrowLeftIcon from '@mui/icons-material/KeyboardArrowLeft';
import KeyboardArrowRightIcon from '@mui/icons-material/KeyboardArrowRight';
import TextWrapper from 'E:/iView Labs/Crayon-newbuild-frontend-master/src/components/common/TextWrapper';
    ...
    return (
        ...
        <CustomCard  handleMouseEnter={() => setIsHovered(true)} handleMouseLeave={() => setIsHovered(false)}>
            ...
            <Grid marginLeft={1} marginRight={1}>
                ...
                <TextWrapper line={1} weight={700} size={20} >Lead Developer Online..</TextWrapper>
                ...
                <Box sx={{ display: 'flex', marginTop: '-5px' }}>
                    <SmallButton color='yellowButton200' height={25} label={i18n['jobCard.tech']} mr='4px' />
                    <SmallButton color='yellowButton200' height={25} label={i18n['jobCard.accounts']} mr='4px' />
