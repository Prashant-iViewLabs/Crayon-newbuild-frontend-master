...
export default function JobsDetailPage() {
    ...
    const [job, setJob] = useState(stateData.state);
        ...
        >
            ...
            >
                <Box
                    ...
                    alt="job_logo"
                    src={
                        job?.employer_profile?.profile_pic !== "No URL"
                            ? job?.employer_profile?.profile_pic
                            : job_logo
                    }
                />
            ...
            <Grid item md={6}>
                ...
                <Grid sx={{
                    ...
                    >
                        ...
                        nobis, cum amet enim quidem officiis ducimus itaque autem
                        repellendus sint debitis quae expedita eum? Molestias temporibus
                        blanditiis, eos iure ipsam cumque deserunt delectus repudiandae nisi
                        ex libero impedit consequatur sed commodi quibusdam fuga nesciunt
                        pariatur at voluptate consequuntur aperiam!
                    </Typography>
                </Grid>
            ...
            <Grid item md={5} marginLeft={0}>
                ...
                <Grid>
                        ...
                        <Box sx={{
                            ...
                            >
                                ...
                                <Typography sx={{
                                    fontSize: 9,
                                    fontWeight: "Bold"
                                }} paragraph>own equipment</Typography>
                            </Box>
                            <Box
                                width={"25%"}
                                display={"flex"}
                            ...
                            >
                                ...
                                <Typography sx={{
                                    fontSize: 9,
                                    fontWeight: "Bold"
                                }} paragraph>Internet Access</Typography>
                            </Box>
                            <Box
                                width={"25%"}
                                display={"flex"}
                            ...
                            >
                                ...
                                <Typography sx={{
                                    fontSize: 9,
                                    fontWeight: "Bold"
                                }} paragraph>Job starts: 13 September 2023</Typography>
                            </Box>
                            <Box
                                width={"25%"}
                                display={"flex"}
                            ...
                            >
                                ...
                                <Typography sx={{
                                    fontSize: 9,
                                    fontWeight: "Bold"
                                }} paragraph>National diploma</Typography>
                            </Box>
                        </Box>
                    </Grid>
                    ...
                    >
                        ...
                        <Grid container display={"flex"} flexWrap={"nowrap"} sx={{
                            background: "green"
                        }}>
